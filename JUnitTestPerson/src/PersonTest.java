...
class PersonTest {
    ...
    void setUp()
    {
        p1 = new Person("00000A", "Billy", "Bob", "Tester1", 1955);
        p2 = new Person("00000B", "Seashell", "Sally", "Tester2", 1975);
        Person.setIDSeed(0);
        p3 = new Person("Bob", "Tester3", "title1", 1960);
        p4 = new Person( "Sally", "Tester4", "title2", 1965);
        p5 = new Person( "Fred", "Tester5", "title3", 970);
        p6 = new Person( "Cindy", "Tester6", "title3", 1975);
